...
function s_doPlugins(a) {
    ...
    // Extra la URL, la decodifica, la pasa a minúsculas, elimina el símbolo "+", elimina los espacios del inicio y del final de la keyword y se asegura que sólo hay un espacio entre cada palabra.
    ...
    /**** getLoadTime ****/
    s.eVar56 = s.prop56 = s_getLoadTime();
...
+ "	}"
+ "	"
+ "	if(s.getQueryParam('SBR')!='' && s.getQueryParam('SBR').indexOf('#')<0){"
+ "		s.eVar2='SEM Branded';"
+ "		s.eVar59='';"
+ "		s.campaign=s.getQueryParam('SBR');"
+ "		s.campaign=s.getValOnce(s.campaign,'s_campaign',0);"
+ "		if(!s.campaign)"
+ "			s.eVar2='';"
+ "	}"
+ "	else if(s.getQueryParam('SNB')!=''&& s.getQueryParam('SNB').indexOf('#')<0){"
+ "		s.eVar2='SEM Non Branded';"
+ "		s.eVar59='';"
+ "		s.campaign=s.getQueryParam('SNB');"
+ "		s.campaign=s.getValOnce(s.campaign,'s_campaign',0);"
+ "		if(!s.campaign)"
+ "			s.eVar2='';"
+ "	}"
+ "	else if(s.getQueryParam('AFI')!=''&& s.getQueryParam('AFI').indexOf('#')<0){"
+ "		s.eVar2='Afiliados';"
+ "		s.eVar59='';"
...
+ "			s.eVar2='';"
+ "	}"
+ "	else if(s.getQueryParam('CID')!=''&& s.getQueryParam('CID').indexOf('#')<0){"
...
+ "			s.eVar2='';"
+ "	}"
+ "	else if(s.getQueryParam('CRM')!=''&& s.getQueryParam('CRM').indexOf('#')<0){"
+ "		s.eVar2='CRM Mailing';"
+ "		s.eVar59='';"
+ "		s.campaign=s.getQueryParam('CRM');"
+ "		s.campaign=s.getValOnce(s.campaign,'s_campaign',0);"
+ "		if(!s.campaign)"
+ "			s.eVar2='';"
+ "	}"
+ "	else if(s.getQueryParam('EXT')!=''&& s.getQueryParam('EXT').indexOf('#')<0){"
...
+ "			s.eVar2='';"
+ "	}"
+ "	else if(s.getQueryParam('MET')!=''&& s.getQueryParam('MET').indexOf('#')<0){"
+ "		s.eVar2='MetaSearches';"
+ "		s.eVar59='';"
+ "		s.campaign=s.getQueryParam('MET');"
+ "		s.campaign=s.getValOnce(s.campaign,'s_campaign',0);"
+ "		if(!s.campaign)"
+ "			s.eVar2='';"
+ "	}"
+ "	else if(s.getQueryParam('SSMM')!=''&& s.getQueryParam('SSMM').indexOf('#')<0){"
+ "		s.eVar2='Social Media';"
+ "		s.eVar59='';"
+ "		s.campaign=s.getQueryParam('SSMM');"
+ "		s.campaign=s.getValOnce(s.campaign,'s_campaign',0);"
+ "		if(!s.campaign)"
+ "			s.eVar2='';"
+ "	}"
+ "	else if(s.getQueryParam('EPV')!=''&& s.getQueryParam('EPV').indexOf('#')<0){"
+ "		s.eVar2='Emails Post-Venta';"
+ "		s.eVar59='';"
+ "		s.campaign=s.getQueryParam('EPV');"
+ "		s.campaign=s.getValOnce(s.campaign,'s_campaign',0);"
+ "		if(!s.campaign)"
+ "			s.eVar2='';"
+ "	}"
+ "	else if(s.getQueryParam('EDA')!=''&& s.getQueryParam('EDA').indexOf('#')<0){"
+ "		s.eVar2='Emails de Alta';"
+ "		s.eVar59='';"
+ "		s.campaign=s.getQueryParam('EDA');"
+ "		s.campaign=s.getValOnce(s.campaign,'s_campaign',0);"
+ "		if(!s.campaign)"
+ "			s.eVar2='';"
+ "	}"
+ "	else if(s.getQueryParam('FDP')!=''&& s.getQueryParam('FDP').indexOf('#')<0){"
+ "		s.eVar2='EMmails de Recuperacion';"
+ "		s.eVar59='';"
+ "		s.campaign=s.getQueryParam('FDP');"
+ "		s.campaign=s.getValOnce(s.campaign,'s_campaign',0);"
+ "		if(!s.campaign)"
+ "			s.eVar2='';"
+ "	}"
+ "	else if(s.getQueryParam('GFL')!=''&& s.getQueryParam('GFL').indexOf('#')<0){"
+ "		s.eVar2='Google Flights';"
+ "		s.eVar59='';"
+ "		s.campaign=s.getQueryParam('GFL');"
+ "		s.campaign=s.getValOnce(s.campaign,'s_campaign',0);"
+ "		if(!s.campaign)"
+ "			s.eVar2='';"
+ "	}"
...
+ "ha.getMinutes();if(m<10)m='0'+m;s.prop62=h;s.eVar62=s.prop62;s.prop63=h"
+ "+':'+m;s.eVar63=s.prop63");
